...
```
	##方式1 (包含下载库和请求封装库）
	implementation 'com.github.zsgfrtttt:HttpUtil:1.1.1'
	##方式2 (子库拆分依赖，需要同时依赖okhttp）
	implementation 'com.github.zsgfrtttt.HttpUtil:download-core:1.1.1@aar'
    	implementation 'com.github.zsgfrtttt.HttpUtil:http-core:1.1.1@aar'
